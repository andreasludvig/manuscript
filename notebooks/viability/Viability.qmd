...
plot_absolute_viability <- 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        legend.key.size = unit(1.2, 'lines'))  # Adjust the size of the legend keys
...
#| fig-cap: "Note that the concentration of ATP of donor one on day 5 was to high. Data for this donor/day not trustworthy/viability to high. Omitted. No data for day 16 for donor 1. Data for donor 3 day 9 was measured on day 10"
#| 
plot_absolute_viability
```
