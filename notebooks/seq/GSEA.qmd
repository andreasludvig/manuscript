...
```{r}
#| label: fig-biocarta-plots1
BIOCARTA_plot_list[[1]]
```

```{r}
#| label: fig-biocarta-plots2
BIOCARTA_plot_list[[2]]
```

```{r}
#| label: fig-biocarta-plots3
BIOCARTA_plot_list[[3]]
```

```{r}
#| label: fig-biocarta-plots4
BIOCARTA_plot_list[[4]]
```

```{r}
#| label: fig-biocarta-plots5
BIOCARTA_plot_list[[5]]
```

```{r}
#| label: fig-biocarta-plots6
BIOCARTA_plot_list[[6]]
```

```{r}
#| label: fig-biocarta-plots7
BIOCARTA_plot_list[[7]]
```

```{r}
#| label: fig-biocarta-plots8
...
```{r}
#| label: fig-reactome-plots1

REACTOME_plot_list[[1]]
```

```{r}
#| label: fig-reactome-plots2

REACTOME_plot_list[[2]]
```

```{r}
#| label: fig-reactome-plots3

REACTOME_plot_list[[3]]
```

```{r}
#| label: fig-reactome-plots4

REACTOME_plot_list[[4]]
```

```{r}
#| label: fig-reactome-plots5

REACTOME_plot_list[[5]]
```

```{r}
#| label: fig-reactome-plots6

REACTOME_plot_list[[6]]
```

```{r}
#| label: fig-reactome-plots7

REACTOME_plot_list[[7]]
```

```{r}
#| label: fig-reactome-plots8
