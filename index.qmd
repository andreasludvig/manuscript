...
We see that supraphysiological levels of IL-6 and IL-1β have a marked effect on the up- and downregulation of the expression of several genes. IL-6 at 10 ng/ml gives rise to an upregulation of \~500 genes, and a downregulation of \~400 genes, whereas IL-1B at the same concentration leads to an up and downregulation of \~650 and and \~550 genes respecitvely. Not surprinsingly, our gene set enrichment analysis

**IL-1β**

![](images/main_seq_IL1B.png){#fig-seq-3}

![](images/seq_il1B_2.png){#fig-seq-1B}

**IL-6**

![Sequencing data for IL-6. Note that there are only 2 sig diff genes in volcano plot a, with log(2) fold change less than -1. No cutoff value set for FC](images/main_seq_IL6.png){#fig-seq-il6}
...
{{< embed notebooks/seq/seq.qmd#fig-reactome-il1b-0.1 >}}

{{< embed notebooks/seq/seq.qmd#fig-reactome-il1b-10 >}}

{{< embed notebooks/seq/seq.qmd#fig-reactome-il6-0.1 >}}

{{< embed notebooks/seq/seq.qmd#fig-reactome-il6-10 >}}

{{< embed notebooks/seq/seq.qmd#fig-reactome-il6-combined >}}

#### **Medium vs vehicle**

{{< embed notebooks/seq/seq.qmd#fig-reactome-medium >}}

{{< embed notebooks/seq/seq.qmd#fig-kegg-medium >}}

{{< embed notebooks/seq/seq.qmd#fig-go-medium >}}

{{< embed notebooks/seq/seq.qmd#fig-go-split-medium >}}
...
{{< embed notebooks/seq/seq.qmd#fig-kegg-il1b-0.1 >}}

{{< embed notebooks/seq/seq.qmd#fig-kegg-il1b-10 >}}

{{< embed notebooks/seq/seq.qmd#fig-kegg-il6-0.1 >}}

{{< embed notebooks/seq/seq.qmd#fig-kegg-il6-10 >}}

{{< embed notebooks/seq/seq.qmd#fig-kegg-il6-combined >}}

**BIOCARTA**

{{< embed notebooks/seq/seq.qmd#fig-biocarta-il1b-0.1 >}}

{{< embed notebooks/seq/seq.qmd#fig-biocarta-il1b-10 >}}

{{< embed notebooks/seq/seq.qmd#fig-biocarta-il6-0.1 >}}

{{< embed notebooks/seq/seq.qmd#fig-biocarta-il6-10 >}}

{{< embed notebooks/seq/seq.qmd#fig-biocarta-il6-combined >}}

{{< embed notebooks/seq/seq.qmd#fig-biocarta-medium >}}
