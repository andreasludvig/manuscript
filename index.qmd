...
![Morphology for donors one, two, and three. Photos from the same well for each donor throughout the experiment. Scale bars represent 200 µm.](images/morph.png){#fig-morph width="4500"}

{{< embed notebooks/viability/Viability.qmd#fig-viability >}}
...
{{< embed notebooks/qPCR/mRNA.qmd#fig-mRNA-CYP3A4 >}}

### Activity

{{< embed notebooks/LCMS/LCMS.qmd#fig-act-il6-combined >}}

{{< embed notebooks/LCMS/LCMS.qmd#fig-act-il1b-combined >}}

#### EC50

{{< embed notebooks/LCMS/LCMS.qmd#fig-dose-response-act-il6 >}}
...
Volcano plot of 10 ng/ml IL-6 vs vehicle

{{< embed notebooks/seq/seq.qmd#fig-volcano-il6-10 >}}

Volcano plot of 0.1 ng/ml IL-6 vs vehicle

{{< embed notebooks/seq/seq.qmd#fig-volcano-il6-0.1 >}}

Volcano plot of pooled IL-1B vs vehicle

{{< embed notebooks/seq/seq.qmd#fig-volcano-il1B-pooled >}}

Volcano plot of 10 ng/ml IL-1B vs vehicle

{{< embed notebooks/seq/seq.qmd#fig-volcano-il1B-10 >}}

Volcano plot of 10 ng/ml IL-1B vs vehicle

{{< embed notebooks/seq/seq.qmd#fig-volcano-il1B-0.1 >}}
...
{{< embed notebooks/qPCR/mRNA.qmd#fig-CYP3A4_supp >}}

{{< embed notebooks/qPCR/mRNA.qmd#fig-rest_of_cyps >}}

{{< embed notebooks/qPCR/mRNA.qmd#fig-rest_of_cyps_overall_mean >}}

### Activity

Below are the mean activity faceted on time (timepoints combined, 24 hour omitted)

{{< embed notebooks/LCMS/LCMS.qmd#fig-act-cyp3A4-IL6 >}}

{{< embed notebooks/LCMS/LCMS.qmd#fig-act-cyp3A4-IL1B >}}

Below are individual donor 3 plots

{{< embed notebooks/LCMS/LCMS.qmd#fig-act_3A4_IL_6_AS0013 >}}

{{< embed notebooks/LCMS/LCMS.qmd#fig-act_3A4_IL_1B_AS0013 >}}

Below are individual donor 2 plots

{{< embed notebooks/LCMS/LCMS.qmd#fig-act_3A4_IL_6_AS0008 >}}

{{< embed notebooks/LCMS/LCMS.qmd#fig-act_3A4_IL_1B_AS0008 >}}
...
{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots1 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots2 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots3 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots4 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots5 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots6 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots7 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-kegg-plots8 >}}

**BIOCARTA**

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots1 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots2 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots3 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots4 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots5 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots6 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots7 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-biocarta-plots8 >}}

**REACTOME**

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots1 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots2 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots3 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots4 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots5 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots6 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots7 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-reactome-plots8 >}}

**GO**

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots1 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots2 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots3 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots4 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots5 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots6 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots7 >}}

{{< embed notebooks/seq/GSEA.qmd#fig-go-plots8 >}}
