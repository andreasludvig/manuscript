...
in Figure~\ref{fig-viability} we see that a relatively stable viability
during the first 9 days of culture, and stayed above 60 percent of the
variability after spheroids formation. Viability for donor was stable
throughout the experiment, for the timepoints measured. Donor 12 was
stable for the first 9 days of the experiment, with a slight dropoff
seen from day 12, but stable hereafter., never dropping below 60 \% of
the viability after spheroid formation. Donor 3 was stable for the first
12 days, with a slight dropoff hereafter. Furthermore, morpholgy was
consistent throughout the experiment, disregardign a tendency for the
spheroids to shrink during the experimentm, which might be due to
...
\includegraphics{images/morph.png}
...
\includegraphics{notebooks/viability/output/viability.png}

}

\caption{\label{fig-viability}``Each point is the mean ATP content of
5-8 spheroids/replicates (mean = 7). There is no data for for donor 1 on
day 5 and 16. Data for donor 3 day 9 was measured on day 10''}
